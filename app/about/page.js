    ...
    <>
      ...
      <main className="bg-[#030712] text-black py-12 px-6 lg:px-24 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="max-w-xl text-white font-mono text-md leading-relaxed">
          <p className="mb-4">
            Even if you don’t know me yet, you’ve likely stumbled onto one of my
            code-fueled rants. CodersYap is where I yell into the void of the
            internet, mostly about code, sometimes about bugs, and occasionally
            about life.
          </p>
          <p className="mb-4">
